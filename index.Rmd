...
> Correlation is a **measure of similarity** between $x$ and $y$ to inform us something about the data. But the intuitive geometric interpretation takes a bit more mathematical training. 
...
$$r_{xy}={\frac {1}{{\color{red} n}-1}}\sum _{i=1}^{n}\left( \color{blue} {\frac {x_{i}-{\bar {x}}}{s_{x}}} \right)  \left( \color{blue} {\frac {y_{i}-{\bar {y}}}{s_{y}}} \right).$$ 
...
.footnote[
.font150[You have all demonstrated that you have the skills to make good statistical arguments in your interview. I believe you can do this all over again for students who are probably smarter than me. ]
]
